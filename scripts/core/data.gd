...
const CALLS := [
	...
	{"true": "fraud_report", "report": "fraud_report", "caller": "女 · 约四十岁 · 焦急",
		...
		"questions": [
			{"q": "对方是怎么找到您的？", "a": "先来电话，自称是客服，讲我收到的东西有质量问题要退款……"},
			{"q": "那您是怎么把钱转出去的？", "a": "他让我点开一个网页，填了卡号和验证码，讲是走退款流程……"},
			{"q": "一共转了多少？", "a": "卡里的钱都转了，是在{road}这边的银行转的……"},
			{"q": "请先别再转账，带好手机来所里做记录。", "a": "好好，我现在就过去，钱还能追回来吗……"},
		],
		"options": ["fraud_report", "prank", "theft"]},
	{"true": "crowd_dispute", "report": "crowd_dispute", "caller": "男 · 约二十五岁 · 外卖骑手",
		"open": "保安不让我们进小区，现在门口围了十几个人，都在闹！",
		"questions": [
			{"q": "现在有没有人动手？", "a": "还没打起来，就是推来推去，保安堵着门不让进。"},
			{"q": "大概围了多少人？", "a": "我们这边的十来个，保安那边三四个，都在{loc}门口。"},
			{"q": "有没有人受伤？", "a": "没有，就是有个人的东西被撞倒了，掉了一地。"},
			{"q": "您先稳住大家，别让事情闹大。", "a": "我在喊了，让他们先散一散……"},
		],
		"options": ["crowd_dispute", "fight", "dispute"]},
	{"true": "dui", "report": "traffic_minor", "caller": "女 · 约三十五岁 · 车主",
		"open": "我的车和别人的车撞了下，对方不想就这样算了，你们来处理一下吧。",
		"questions": [
			{"q": "有没有人受伤？", "a": "人没事，就是车门瘪了。"},
			{"q": "对方司机现在什么状态？", "a": "他坐在车里，一看就喝多了，还想开车走！"},
			{"q": "车现在停在哪里？", "a": "就在{road}和建设路的路口，他车还横在道上。"},
			{"q": "您先别让他发动车，我们马上派交警。", "a": "我拦着呢，他非要走……"},
		],
		"options": ["traffic_minor", "dui", "jam"]},
	{"true": "crowd_dispute", "report": "fight", "caller": "女 · 约五十岁 · 路人",
		"open": "打起来了打起来了！好多人在推来推去！",
		"questions": [
			{"q": "有没有人真的动手打人？", "a": "没有打，就是你推我我推你，没人挥拳头……"},
			{"q": "是怎么起的冲突？", "a": "好像是店家和顾客在闹，讲东西有质量问题，围了好多人。"},
			{"q": "有没有人拿东西？", "a": "没有，就是嗓门特别大，有人在拿手机照相。"},
			{"q": "位置在哪里？", "a": "{loc}的店门口，人越围越多。"},
		],
		"options": ["fight", "crowd_dispute", "dispute"]},
	{"true": "lost_child", "report": "missing", "caller": "男 · 约四十岁 · 家属",
		"open": "我家老人走丢了！他记忆不好，今天出门到现在没回来！",
		"questions": [
			{"q": "老人穿什么衣服？有什么特征？", "a": "蓝色衣服，头发白了……对了，他还带着我儿子！"},
			{"q": "您儿子多大？", "a": "四岁！两个人一起出去的，讲去{loc}公园玩……"},
			{"q": "后来还通电话吗？", "a": "白天还通了，老人讲在公园，后来就打不通了。"},
			{"q": "您先别急，我们马上派警力分头找。", "a": "好好，我把照片发过去，求你们了……"},
		],
		"options": ["missing", "lost_child", "dispute"]},
	{"true": "fraud_report", "report": "theft", "caller": "男 · 约六十岁 · 着急",
		"open": "我的钱被盗了！卡里的钱全没了！你们快查查！",
		"questions": [
			{"q": "您是几点发现钱不见的？", "a": "就是刚才！我查了下手机，钱是分几次转出去的……"},
			{"q": "有没有人拿过您的手机或银行卡？", "a": "没有……就是有人打来电话，自称是公安，让我把钱转到安全账户……"},
			{"q": "一共转了多少？", "a": "全部的钱啊！是在{road}那边的银行转的……"},
			{"q": "这是诈骗，先别再转账，马上来所里。", "a": "啊？可是他讲我不转就要抓我……"},
		],
		"options": ["theft", "fraud_report", "robbery"]},
]
